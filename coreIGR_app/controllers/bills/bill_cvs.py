...
def bill_cvs(req, tin, vehicle_type, engine_size, cost_price, chassis, staff, office ):
	...
	try:
		...
		# 2.1 - 3.0   -  Above 1 million
				...
				amount = charge_vehicle_linces.amount or 0
		...
		# 1.6 - 2.0   -  Price of vehicle below 1 million
				...
				amount = charge_price_of_vehicle_below_1m.amount or 0
		...
		# 3.1 - Above   -  Price of vehicle below 1 million
				...
				particulars = "Registration for Price of vehicle below 1 million";
				amount = charge_vehicle_below_1m.amount or 0
				...
				particulars = "Vehicle License [3.1 - above]";
				amount = charge_vehicle_license_above_3.amount or 0
				...
				particulars = "Hackney permit";
				amount = charge_hackney_permit.amount_permit.amount or 0
