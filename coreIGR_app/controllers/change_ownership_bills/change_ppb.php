...
if ($engine_size == "1.6 - 2.0" && $cost_price =="Price of vehicle above 1 million"){
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Private Pickup/Bus' AND `particulars`='Inspection Fee'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Private Pickup/Bus' AND `particulars`='New Plate Number'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Private Pickup/Bus' AND `particulars`='Price of vehicle above 1 million'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
if ($engine_size == "1.6 - 2.0" && $cost_price =="Price of vehicle below 1 million"){
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Private Pickup/Bus' AND `particulars`='Price of vehicle below 1 million'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
