...
if ($engine_size == "6 - 8 tyres"){
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Truck/Trailer/Lorry/Tipper' AND `particulars`='Registration Fee'";
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Truck/Trailer/Lorry/Tipper' AND `particulars`='Inspection Fee'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Truck/Trailer/Lorry/Tipper' AND `particulars`='New Plate Number'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
