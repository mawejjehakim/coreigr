...
if ($engine_size == "Tricycle"){
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Registration Fee'";
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='New Plate Number'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Certificate of road worthiness'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Vehicle License Tricycle'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Hackney permit'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Driver Badge'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
if ($engine_size == "Motocycle"){
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Vehicle License Motorcycle'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
//Get particulars [SMS Alert]
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='SMS Alert'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Tricycle/Motorcycle' AND `particulars`='Stamp Duty'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
