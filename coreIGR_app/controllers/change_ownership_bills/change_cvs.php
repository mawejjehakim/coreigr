...
if ($engine_size == "1.6 - 2.0" && $cost_price =="Price of vehicle above 1 million"){
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Registration Book'";
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Inspection Fee'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Proof of ownership'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='New Plate Number'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Price of vehicle above 1 million'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Certificate of road worthiness'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Vehicle License [1.6 - 2.0]'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Hackney permit'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Driver Badge'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
if ($engine_size == "2.1 - 3.0" && $cost_price =="Price of vehicle above 1 million"){
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Vehicle License [2.1 - 3.0]'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
if ($engine_size == "3.1 - Above" && $cost_price =="Price of vehicle above 1 million"){
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Vehicle License [3.1 - above]'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
if ($engine_size == "1.6 - 2.0" && $cost_price =="Price of vehicle below 1 million"){
		...
		$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Price of vehicle below 1 million'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
...
//Get particulars [SMS Alert]
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='SMS Alert'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
	...
	$sql = "SELECT * FROM `tbl_coreigr_charges` WHERE `opt`='New' AND `vehicle_type`='Commercial Vehicle Saloon' AND `particulars`='Stamp Duty'";
		$row = mysqli_fetch_array(mysqli_query($conn,$sql));	
